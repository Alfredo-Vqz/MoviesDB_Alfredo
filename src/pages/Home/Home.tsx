...
const Home: React.FC = () => {
    const [popularMovies, setPopularMovies] = useState<IMovieResponse[] | undefined>(undefined);
    const [topRatedMovies, setTopRatedMovies] = useState<IMovieResponse[] | undefined>(undefined);
    const [upcomingMovies, setUpcomingMovies] = useState<IMovieResponse[] | undefined>(undefined);
                ...
                <div className="movie-section px-6 py-8">
                    ...
                    <div className="slider-container flex overflow-x-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-800">
                        <div className="flex ml-5 mt-5">
                            {/* Map over popular movies and render MovieCard component */}
